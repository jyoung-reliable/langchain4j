...
import static dev.langchain4j.agentic.SupervisorAgentIT.model;
import static dev.langchain4j.agentic.SupervisorAgentIT.plannerModel;
...
public class HoroscopeMain {
    ...
    public static void main(String[] args) {
        ...
        PromptAgent horoscopeAgent = SupervisorAgentService.builder(plannerModel)
