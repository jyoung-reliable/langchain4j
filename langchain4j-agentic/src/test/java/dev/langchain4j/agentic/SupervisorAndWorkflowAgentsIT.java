...
public class SupervisorAndWorkflowAgentsIT {
    ...
    static final ChatModel supervisorModel = OllamaChatModel.builder()
            .baseUrl(OLLAMA_BASE_URL)
            .modelName("qwen3:8b")
            .timeout(Duration.ofMinutes(10))
            .temperature(0.0)
    ...
    void typed_loop_agents_test() {
        ...
        PromptAgent styledWriter = SupervisorAgentService.builder(supervisorModel)
